...
<head>
    ...
    <title>Book Cover - KEERTHANA S</title>
    <style>
    ...
    <div class="book-cover">
        ...
        <div class="footer">
            <div class="footer-text">
                ...
                <p class="author-name">MS.KEERTHANA S G</p>
            </div>
            <div class="author-photo">
                <img src="image.png" alt="KEERTHANA S"> 
            </div>
        </div>
    </div>
...
## OUTPUT:
<img width="899" height="1599" alt="image" src="https://github.com/user-attachments/assets/cc060a99-4e64-4812-8713-365f62f0376f" />
